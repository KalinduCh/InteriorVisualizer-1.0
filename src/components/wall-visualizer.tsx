...
const featureAreaColorMap = {
    ...
    'white-blue-gold': "bg-[radial-gradient(ellipse_at_center,_white_20%,_#f5faff_80%)] border-blue-200 bg-[repeating-linear-gradient(45deg,_transparent,_transparent_80px,_rgba(218,165,32,0.5)_82px,_transparent_85px),repeating-linear-gradient(60deg,_transparent,_transparent_100px,_rgba(30,144,255,0.3)_102px,_transparent_105px)] mix-blend-multiply",
    'white-dark-gold': "bg-[radial-gradient(ellipse_at_center,_#ffffff_20%,_#fef9f0_80%)] border-yellow-700 bg-[repeating-linear-gradient(45deg,_transparent,_transparent_100px,_rgba(184,134,11,0.6)_102px,_transparent_105px),repeating-linear-gradient(70deg,_transparent,_transparent_70px,_rgba(160,82,45,0.3)_72px,_transparent_75px)] mix-blend-multiply"
};
